...
from system_core_FastROR.module.stn import spatial_transformer_network as transformer
from system_core_FastROR import locality_aware_nms as nms_locality
from system_core_FastROR import lanms
...
from system_core_FastROR.module import Backbone_branch, RoI_rotate, classification_branch
from system_core_FastROR.data_provider.data_utils import restore_rectangle
        ...
        while (True):
            ...
            if boxes is not None and boxes.shape[0] != 0:
                ...
                # ten times recognition
                    ...
                    recog_list.append(im_pred)
                    recog_num += 1


                    RTT_pred_name = "{}% {}".format(int(confidence_pred * 100), class_pred)
                else:
                    RTT_pred_name = "None"
                    recog_none += 1
                    if recog_none > 9:
